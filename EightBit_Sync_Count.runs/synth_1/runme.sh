...
HD_PWD='C:/Xilinx/Vivado/FourBit_Sync_Count/FourBit_Sync_Count.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FourBit_Sync_Count.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FourBit_Sync_Count.tcl
